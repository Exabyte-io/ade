...
import type { BaseInMemoryEntitySchema, FlavorPropertiesSchema } from "@mat3ra/esse/dist/js/types";

export type FlavorSchemaMixin = FlavorPropertiesSchema;

export type FlavorInMemoryEntity = InMemoryEntity<BaseInMemoryEntitySchema & FlavorSchemaMixin>;
